...
system("plink --bfile ~/projects/carot_data/dat/casesis1 --missing", intern=TRUE)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1 --geno 0.2 --make-bed --out ~/projects/carot_data/dat/casesis1c1", intern=T)

# Delete individuals with missingness >0.2.
system("plink --bfile ~/projects/carot_data/dat/casesis1c1 --mind 0.2 --make-bed --out ~/projects/carot_data/dat/casesis1c2", intern=T)

# Delete SNPs with missingness >0.02.
system("plink --bfile ~/projects/carot_data/dat/casesis1c2 --geno 0.02 --make-bed --out ~/projects/carot_data/dat/casesis1c3", intern=T)

# Delete individuals with missingness >0.02.
system("plink --bfile ~/projects/carot_data/dat/casesis1c3 --mind 0.02 --make-bed --out ~/projects/carot_data/dat/casesis1c4", intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c4 --check-sex", intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c4 --remove sex_discrepancy.txt --make-bed --out ~/projects/carot_data/dat/casesis1c5", intern=T) 
...
# system("awk '{ if ($1 >= 1 && $1 <= 22) print $2 }' ~/projects/carot_data/dat/casesis1c5.bim > snp_1_22.txt", intern=T)
# 
# system("plink --bfile ~/projects/carot_data/dat/casesis1c5 --extract snp_1_22.txt --make-bed --out ~/projects/carot_data/dat/casesis1c6",
#        intern=T)

# bypass the sex check (original code above)

system("awk '{ if ($1 >= 1 && $1 <= 22) print $2 }' ~/projects/carot_data/dat/casesis1c4.bim > snp_1_22.txt", intern=T)

system("plink --bfile ~/projects/carot_data/dat/casesis1c4 --extract snp_1_22.txt --make-bed --out ~/projects/carot_data/dat/casesis1c6",
       intern=T)
...
system("plink --bfile .~/projects/carot_data/dat/casesis1c6 --freq --out MAF_check", intern=T)
...
# Note: if start with casesis1c5 data then NOT selecting only autosomal SNPs
# if you start with casesis1c6 you remove non-autosomal SNPS
# to do: do we expect non-autosomal SNPs to be associated with carotenoids?
#system("plink --bfile ~/projects/carot_data/dat/casesis1c6 --maf 0.02 --make-bed --out ~/projects/carot_data/dat/casesis1c7", intern=T)

system("plink --bfile ~/projects/carot_data/dat/casesis1c6 --maf 0.02 --make-bed --out ~/projects/carot_data/dat/casesis1c8", intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c7 --hardy", intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c7 --hwe 1e-6 --make-bed --out ../carot_data/hwe_filter_step1", intern=T)
...
system("plink --bfile ../carot_data/hwe_filter_step1 --hwe 1e-10 --hwe-all --make-bed --out ~/projects/carot_data/dat/casesis1c8", intern=T)
...
<!-- NOTE: this was first tested out in the intersect.Rmd file. -->
...
wc -l ~/projects/carot_data/dat/snp-sub-sorted.txt
wc -l ~/projects/carot_data/dat/snp-case-sorted.txt
wc -l ~/projects/carot_data/dat/intersecting_snps.txt

## Extract data using intersecting_snps.txt from origninal file sets
plink --bfile ~/projects/carot_data/dat/casesis1c8 --extract ~/projects/carot_data/dat/intersecting_snps.txt --make-bed --out  ~/projects/carot_data/dat/casesis1c8_intersect
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c8 --exclude ../carot_qc/GWA_tutorial/1_QC_GWAS/inversion.txt --range --indep-pairwise 50 5 0.2 --out ../carot_data/indepSNP", 
       intern=T)
# Note, don't delete the file indepSNP.prune.in, we will use this file in later steps of the tutorial.

system("plink --bfile ~/projects/carot_data/dat/casesis1c8 --extract ../carot_data/indepSNP.prune.in --het --out ../carot_data/R_check", intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c8 --remove het_fail_ind.txt --make-bed --out ~/projects/carot_data/dat/casesis1c9",
intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c9 --extract ../carot_qc/indepSNP.prune.in --genome --min 0.2 --out ../carot_qc/pihat_min0.2", intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c9 --filter-founders --make-bed --out ~/projects/carot_data/dat/casesis1c10", 
       intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c10 --extract ../carot_qc/indepSNP.prune.in --genome --min 0.2 --out ../carot_qc/pihat_min0.2_in_founders",
       intern=T)
...
system("plink --bfile ~/projects/carot_data/dat/casesis1c10 --missing", intern=T)
